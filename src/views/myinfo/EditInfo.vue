    ...
    <div class="content content_box">
      ...
      >
        ...
        <div class="p-10 border_b flex-a-center a-center">
          ...
          <div class="content_r">
            <van-radio-group v-model="userInfo.gender" class=" flex-j-around" style="margin-left:-22px">
...
export default {
  ...
  methods: {
    ...
    formatDate(date) {
      userInfo.year = date.getFullYear();
      userInfo.month = date.getMonth() + 1;
      userInfo.day = date.getDate();
